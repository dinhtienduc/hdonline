...
<script src="{!!asset('user/js/simplePlayer.js')!!}"></script>
<script>
	            	...
	            	<div class="col-sm-12">
		            	<div class="col-sm-6 single-left">
		            		<div class="song">
								<div class="video-grid-single-page-agileits">
									<div data-video="y6Zz-kgf4L8" id="video">
										<img src="{!!asset('user/images/2.jpg')!!}" alt="" class="img-responsive" />
									</div>
								</div>
							</div>
		            	</div>
		            	<div class="col-md-4 single-right">
							...
							<div class="col-md-4 single-right-grid-left">
								<a href="single.html"><img src="{!!asset('user/images/m15.jpg')!!}" alt="" /></a>
							</div>
